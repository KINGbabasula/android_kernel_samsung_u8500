...
#else #CONFIG_ANDROID_LOW_MEMORY_KILLER_DO_NOT_KILL_PROCESS
...
#endif #CONFIG_ANDROID_LOW_MEMORY_KILLER_DO_NOT_KILL_PROCESS
...
#elseif CONFIG_ANDROID_LOW_MEMORY_KILLER_DO_NOT_KILL_PROCESS
